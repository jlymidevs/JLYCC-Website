...
const nationalRegions: Region[] = [
  {
    ...
    churches: [
      { name: "JLYCC Dasmañrias", pastor: "Pastor Vivian O. Adarle", address: "B106 L008 Brgy. Sta. Lucia, Dasmañrias City, Cavite", fb: "https://www.facebook.com/jlycc.dasmarinas.9" },
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-4 shadow-sm">
      <div className="flex items-start justify-between gap-2 mb-1">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-gray-900 dark:text-white text-sm leading-snug">{church.flag && `${church.flag} `}{church.name}</span>
        </div>
          ...
          >
            <div className="max-h-72 overflow-y-auto">
              {region.churches.map((church, i) => (
                <div key={church.name} className={`px-4 py-3 ${i !== region.churches.length - 1 ? "border-b border-gray-100 dark:border-gray-700" : ""}`}>
    ...
    >
      <div className="container-section" ref={ref}>
        ...
        >
          <div className="flex gap-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl pl-12 pr-10 py-4 text-gray-800 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 text-sm focus:outline-none focus:border-teal-500 transition-colors shadow-sm"
          ...
          {search && (
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-3 pl-1">
        ...
        {search && (
          ...
          >
            {searchResults.length > 0 ? (
              ...
              <p className="text-center text-gray-400 dark:text-gray-500 py-8">No churches found for &quot;{search}&quot;</p>
            )}
          </motion.div>
        )}
          ...
          <>
            ...
            >
              <div className="flex items-center gap-3 mb-5">
                ...
                <h3 className="font-heading font-black text-gray-800 dark:text-white text-lg">International Churches</h3>
              </div>
            ...
            >
              <div className="flex items-center gap-3 mb-5">
                ...
                <h3 className="font-heading font-black text-gray-800 dark:text-white text-lg">
