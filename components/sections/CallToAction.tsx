...
export default function CallToAction() {
  ...
  return (
    <section className="py-24 bg-primary relative overflow-hidden" aria-labelledby="cta-heading" ref={ref}>
      ...
      <div className="container-section relative text-center">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.7 }}>
          ...
          <h2 id="cta-heading" className="font-heading text-4xl md:text-5xl font-black text-white mb-6">ANSWER THE CALL<br />WITH EXCELLENCE</h2>
          <p className="text-white/80 text-lg max-w-2xl mx-auto mb-4 leading-relaxed">We don't just impart knowledge; we forge character. Our environment is designed to strip away complacency and build spiritual generals.</p>
          ...
          <a href="#stay-updated" className="inline-flex items-center gap-2 bg-white text-teal-700 font-bold px-8 py-4 rounded-full hover:bg-teal-50 transition-all hover:scale-105 active:scale-95 shadow-lg group">
            Get Involved <ArrowRight size={18} className="transition-transform group-hover:translate-x-1" />
          </a>
        </motion.div>
      </div>
    </section>
