        ...
        <div ref={ref} className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 id="about-heading" className="section-title mb-6">
              A Legacy of <span className="text-teal-500">Spiritual Authority</span>
            </h2>
            <p className="text-dark/70 text-lg leading-relaxed mb-5">
            ...
            <ul className="space-y-4 mb-10">
              {features.map(({ title, desc, color }) => (
                <li key={title} className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-heading font-bold text-dark text-sm">{title}</div>
                    <div className="text-dark/50 text-sm">{desc}</div>
                  </div>
                </li>
              ))}
            </ul>
